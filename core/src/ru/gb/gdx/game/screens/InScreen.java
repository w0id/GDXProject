...
public class InScreen implements Screen, InputProcessor {
    ...
    public InScreen(Game game) {
        ...
        texture = new Texture("StartScreen.jpg");
    ...
    public void render(final float delta) {
        ...
        batch.end();
        if (Gdx.input.isKeyJustPressed(Input.Keys.ANY_KEY) || Gdx.input.isButtonJustPressed(Input.Buttons.LEFT) || Gdx.input.justTouched()) {
            dispose();
